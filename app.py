...
def download_report():
    ...
    pdf.drawCentredString(width / 2, 730, "LIBRARY MANAGEMENT REPORT")
    ...
    pdf.drawString(80, y, f"Total Students : {total_students}")
    y -= 45

    pdf.drawString(80, y, f"Total Staff : {total_staff}")
    y -= 45

    pdf.drawString(80, y, f"Total Books : {total_books}")
    y -= 45

    pdf.drawString(80, y, f"Available Books : {available_books}")
    y -= 45

    pdf.drawString(80, y, f"Student Issued Books : {issued_books}")
    y -= 45

    pdf.drawString(80, y, f"Returned Books : {returned_books}")
    y -= 45

    pdf.drawString(80, y, f"Staff Issued Books : {staff_issued}")
    ...
    pdf.drawCentredString(width / 2, 40, "Generated by Library Management System")
    ...
    response.headers["Content-Disposition"] = "attachment; filename=Library_Report.pdf"
